...
APRIL_TAG_SIZE_M_WIRE_TASK = 0.03
WIRE_TARGET_VERTICAL_M = 0.075  # Vertical clearance.
...
def wire_replug(safety_on: bool = True):
    ...
    if safety_on:
        confirm_keys("MOVE ABOVE AND ALIGN <WIRE>")
    else:
        time.sleep(1)
